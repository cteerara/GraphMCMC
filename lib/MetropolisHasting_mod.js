...
function GetAddableEdges(S){
  ...
  // OUTPUT: An array of edges that are valid to add
...
function GetRemovableEdges(S){
  // INPUT: State object S
  // OUTPUT: An Array of edges that are valid to remove
...
function GetCandidate(S){
  //INPUT: State object S
  //OUTPUT: candidate state with either 1 edge added or deleted, and a random source vertex
